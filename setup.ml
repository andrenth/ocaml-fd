...
(* OASIS_START *)
(* DO NOT EDIT (digest: c5300ae147e52c95193776ed7a1105ba) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("fd", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("fd", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
            ...
            [
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "fd"; FindlibPackage ("unix", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "fexecve.ml"; });
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "mycat.ml"; });
               Executable
                 ({
                     cs_name = "openfile";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "openfile.ml"; })
            ];
          plugins = [];
